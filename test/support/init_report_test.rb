...
class InitReportTest  < Minitest::Test
  ...
  def test_report_kvs
    ...
    init_kvs["Ruby.AppOptics.Version"].must_equal AppOptics::Version::STRING
    init_kvs["Ruby.TraceMode.Version"].must_equal AppOptics::Config[:tracing_mode]
  end

  def test_legacy_report_format
    init_kvs = ::AppOptics::Util.legacy_build_init_report
    init_kvs.is_a?(Hash)
  end
end

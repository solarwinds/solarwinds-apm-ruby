...
describe "TraceStateTest" do
  ...
  it "does not accept an empty parent_id" do
    trace_state = "aa=123,bb=234,cc=567"
    trace_state2 = SolarWindsAPM::TraceState.add_sw_member(trace_state, '')
  ...
  it "does not accept a malformed parent_id" do
    trace_state = "aa=123,bb=234,cc=567"
    trace_state2 = SolarWindsAPM::TraceState.add_sw_member(trace_state, '136dxx_742362')
  ...
  describe 'add_sw_member enforce limits' do
    it 'shortens tracestate if it becomes too long' do
      ...
      trace_state3 = SolarWindsAPM::TraceState.add_sw_member("#{trace_state1},#{trace_state2}", id)
    ...
    it 'does not remove entries if tracestate is 512 char long' do
      ...
      trace_state3 = SolarWindsAPM::TraceState.add_sw_member("#{trace_state1},#{large_entry},#{trace_state2}", id)
    ...
    it 'only removes one entry longer than 128 chars' do
      ...
      trace_state3 = SolarWindsAPM::TraceState.add_sw_member("#{trace_state1},#{large_entry1},#{trace_state2},#{large_entry2}", id)

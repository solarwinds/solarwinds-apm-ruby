...
describe "TraceStateTest" do
  ...
  it "omits invalid members" do
    ...
    assert_equal("sw=136DFAEBDF742362-01,aa=123,cc=567", trace_state2)
  end
  ...
  it "rejects values that are too long" do
    ...
    assert_equal("sw=136DFAEBDF742362-01,bb=234,cc=567", trace_state2)
  end
  ...
  it "will not exceed 32 members" do
    ...
    assert_equal("sw=136DFAEBDF742362-01,a0=123,a1=123,a2=123,a3=123,a4=123,a5=123,a6=123,a7=123,a8=123,a9=123,a10=123,a11=123,a12=123,a13=123,a14=123,a15=123,a16=123,a17=123,a18=123,a19=123,a20=123,a21=123,a22=123,a23=123,a24=123,a25=123,a26=123,a27=123,a28=123,a29=123,a30=123", trace_state2)
  end

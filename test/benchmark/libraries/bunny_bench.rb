...
# profile the code
  ...
  @queue = @ch.queue("ao.ruby.test")
  @exchange = @ch.topic("ao.ruby.topic.tests", :auto_delete => true)
  n.times do
...
Benchmark.ips do |x|
  ...
  # x.report('bunny_pub___n_loaded_l') do
  ...
  #   dostuff
  # end
  # x.report('bunny_pub______never_l') do
  ...
  #   dostuff
  # end
  # x.report('bunny_pub_n_sampling_l') do
  #   AppOptics.loaded = true
  ...
  #   dostuff
  # end
  x.report('bunny_pub___sampling_l') do
    AppOptics.loaded = true
    AppOptics::Config[:tracing_mode] = 'always'
    AppOptics::Context.fromString('2B7435A9FE510AE4533414D425DADF4E180D2B4E3649E60702469DB05F01')

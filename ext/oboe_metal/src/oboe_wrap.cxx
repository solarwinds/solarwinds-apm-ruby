...
SWIGINTERN VALUE
_wrap_Context_init_reporter(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","Context::init_reporter", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","Context::init_reporter", 2, argv[1] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
  result = (int)Context::init_reporter((char const *)arg1,(char const *)arg2);
  vresult = SWIG_From_int(static_cast< int >(result));
...
SWIGINTERN void
free_SslReporter(void *self) {
    SslReporter *arg1 = (SslReporter *)self;
    delete arg1;
}
...
SWIGEXPORT void Init_oboe_metal(void) {
  ...
  rb_define_singleton_method(SwigClassContext.klass, "init_reporter", VALUEFUNC(_wrap_Context_init_reporter), -1);

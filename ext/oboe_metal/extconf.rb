...
if ENV['OBOE_FROM_S3'].to_s.downcase == 'true'
  ao_path = File.join('https://agent-binaries.global.st-ssp.solarwinds.com/?prefix=apm/c-lib/', version)
  puts 'Fetching c-lib from S3'
else
  ao_path = File.join('https://agent-binaries.cloud.solarwinds.com/?prefix=apm/c-lib/', version)
end

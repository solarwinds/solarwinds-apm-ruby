  ...
  module Inst
    module Cassandra
      ...
      def insert_with_appoptics(column_family, key, hash, options = {})
        ...
        AppOpticsAPM::SDK.trace(:cassandra, kvs: report_kvs) do
      ...
      def multi_get_columns_with_appoptics(column_family, key, *columns_and_options)
        ...
        AppOpticsAPM::SDK.trace(:cassandra, kvs: report_kvs, protect_op: :multi_get_columns) do
      ...
      def get_with_appoptics(column_family, key, *columns_and_options)
        ...
        AppOpticsAPM::SDK.trace(:cassandra, kvs: report_kvs, protect_op: :get) do
      ...
      def get_range_batch_with_appoptics(column_family, options = {})
        ...
        AppOpticsAPM::SDK.trace(:cassandra, kvs: report_kvs, protect_op: :get_range_batch) do

    ...
    class << self
      ...
      def start
        ...
        unless defined?(::Rails) || defined?(::Sinatra) || defined?(::Padrino) || defined?(::Grape)
          SolarWindsAPM::API.report_init unless ENV.key?('SW_APM_GEM_TEST')
        end
      end
  ...
  class << self
    def sample?(opts = {})
      begin
        ...
        return true if ENV.key?('SW_APM_GEM_TEST')
        ...
        sr_cfg = Java::ComTracelyticsJoboe::LayerUtil.shouldTraceRequest(SW_APM_STR_BLANK, { 'X-Trace' => opts[:xtrace] })
